...
import com.ostoliarov.webproject.controller.ApplicationResources.{MSG_PERIODICAL_PUBLISHER_ERROR, MSG_SUCCESS, STATUS_CODE_SUCCESS, STATUS_CODE_VALIDATION_FAILED}
...
/**
	...
	*/
class PeriodicalPublisherValidatorTest extends FlatSpecWithScalaMockBase {

...
import com.stolser.javatraining.webproject.controller.ApplicationResources.{MSG_SUCCESS, MSG_USER_PASSWORD_ERROR, STATUS_CODE_SUCCESS, STATUS_CODE_VALIDATION_FAILED}
